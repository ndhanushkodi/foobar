...
provider "aws" {
  region = "us-east-1"
  # Credentials should be provided via environment variables or
  # HCP Terraform workspace variables (AWS_ACCESS_KEY_ID,
  # AWS_SECRET_ACCESS_KEY) — never hardcoded in configuration.
}
